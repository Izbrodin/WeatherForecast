...
class OpenWeatherAPI {
    ...
    static func requestCurrentWeather(completion: @escaping (WeatherCodable?, Error?) -> Void) {
        ...
        AF.request(url, method: .get).validate()
            ...
            case .success:
                if let jsonData = response.data {
                    ...
                    let codableWeather = try? decoder.decode(WeatherCodable.self, from: jsonData)
